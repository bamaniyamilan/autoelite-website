        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Premium mobile car servicing delivered to your doorstep. Experience elite automotive care with convenience and professionalism.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Tire Service</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">AC Service</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              <p>+91-9876543210</p>
              <p>hello@autoelite.com</p>
              <p>24/7 Customer Support</p>
              <p>Service Areas: Delhi NCR, Mumbai, Bangalore</p>
            </div>
          </div>
        </div>
